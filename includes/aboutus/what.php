<style>
    ...
    <header class="container my-5">
        <div class="row align-items-center text-center text-lg-start">
            ...
            <div class="col-lg-6 order-lg-2 mb-4 mb-lg-0">
                <img src="assets/aboutus/hero.svg"
                     alt="Three stakeholders discussing over a round table" 
    ...
    <!-- What we do Section -->
    <section class="container my-5 d-flex flex-column flex-lg-row justify-content-center align-items-center gap-5">
    <div class="d-flex flex-column flex-md-row gap-4 w-75 mx-auto w-lg-50">
        <div class="w-50">
            <img src="assets/aboutus/plant-bulb.svg" alt="" class="img-fluid rounded mb-2" style="height: 200px; object-fit: cover;">
            <hr class="border-primary">
            <img src="assets/aboutus/factories-emmiting-smoke.svg" alt="" class="img-fluid rounded mt-2" style="height: 200px; object-fit: cover;">
        </div>
        <div class="mx-2" style="width: 1px; background: linear-gradient(to bottom, #1E3A8A 80%, #fff 20%);"></div>
        <div class="w-50">
            <img src="assets/aboutus/chart-on-white-paper.svg" alt="" class="img-fluid rounded mb-2" style="height: 200px; object-fit: cover;">
            <hr class="border-primary">
            <img src="assets/aboutus/tree.svg" alt="" class="img-fluid rounded mt-2" style="height: 200px; object-fit: cover;">
        </div>
    </div>
    <div class="my-5 w-lg-50">
        <div class="mb-4">
