...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-2 mb-4 animated slideInDown" style="color: #FF4B1F;">Contact Us</h1>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">FIll in the details and we write back to you.</p>
                    <form method="post" action="includes/contact/send.php">
                        <div class="row g-3">
                            <div class="col-md-6">
